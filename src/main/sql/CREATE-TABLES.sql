...
create table APP_USER_ROLES (USER_ID bigint not null, ROLE_ID bigint not null, primary key (USER_ID, ROLE_ID))
...
alter table APP_USER add constraint UK_l2aubhk7g9o13bi6i4gyhxdbc unique (USERNAME)
...
alter table APP_USER_ROLES add constraint FKeude7r75wg3oyne2bvbm3uo42 foreign key (ROLE_ID) references APP_ROLE
alter table APP_USER_ROLES add constraint FKsh2fvo2k7sh6ogly2xakbprgd foreign key (USER_ID) references APP_USER
