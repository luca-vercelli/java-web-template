...
public class doPasswordRecovery extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String address = request.getParameter("address"); //request's data not reliable
			...
			mailManager.sendSimpleTextMail(email, "Password reset",
					"You have requested to reset webapp login password. "
							+ "If you really want to proceed, click here, then follow instructions.");
			//TODO
